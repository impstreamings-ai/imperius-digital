  ...
  return (
    <section className="relative pt-32 sm:pt-36 pb-10 sm:pb-12">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, oklch(0.5 0.03 258 / 0.14), transparent 70%)",
        }}
      />
    ...
    >
      <div className="relative h-44 sm:h-48 overflow-hidden bg-[oklch(0.15_0_0)]">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 30% 20%, oklch(0.5 0.03 258 / 0.18), transparent 60%)",
          }}
        />
  ...
  return (
    <section className="pt-14 sm:pt-20 pb-24 sm:pb-28 relative">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, oklch(0.5 0.03 258 / 0.12), transparent 70%)",
        }}
      />
      <div className="relative mx-auto max-w-3xl px-6 text-center">
