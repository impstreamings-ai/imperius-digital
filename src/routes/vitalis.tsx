  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.86 0.10 220 / 0.28), transparent 70%)",
        }}
      />
      ...
      <div className="relative mx-auto max-w-7xl px-6 grid lg:grid-cols-[1.05fr_1fr] gap-14 lg:gap-20 items-center w-full">
        <div>
          <div
            ...
            style={{ borderColor: "oklch(0.86 0.10 220 / 0.45)", background: "oklch(0.86 0.10 220 / 0.10)" }}
          >
            <span
              className="grid h-6 w-6 place-items-center rounded-full"
              style={{ background: "oklch(0.86 0.10 220 / 0.22)", boxShadow: "0 0 18px -2px oklch(0.86 0.10 220 / 0.65)", outline: "1px solid oklch(0.86 0.10 220 / 0.55)" }}
            >
              <HeartPulse className="h-3.5 w-3.5" style={{ color: "oklch(0.90 0.08 220)" }} />
            </span>
            <span className="text-[11px] uppercase tracking-[0.22em] text-foreground font-semibold">
              Clínica Vitalis<span style={{ color: "oklch(0.90 0.08 220)" }}>™</span>
            </span>
