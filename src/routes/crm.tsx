      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="relative grid sm:grid-cols-2 lg:grid-cols-5 gap-5 sm:gap-6">
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent, oklch(0.7 0.032 258 / 0.45), transparent)",
            }}
          />
          {steps.map((s, idx) => (
            <div
        ...
        <div className="h-1.5 rounded-full bg-card/60 overflow-hidden">
          <div
            ...
            style={{
              width: "87%",
              background:
                "linear-gradient(90deg, oklch(0.55 0.025 258), oklch(0.78 0.03 258))",
            }}
          />
        </div>
      </div>
          ...
          {bars.map((h, i) => (
            <div
              ...
              style={{
                height: `${h}%`,
                background:
                  "linear-gradient(180deg, oklch(0.78 0.03 258), oklch(0.4 0.025 258 / 0.55))",
              }}
            />
          ))}
        </div>
